...
import { execAfterLeftMound, execDuringGame, execTest } from './util/scheduler';

const BEFORE_GAME_NIGHT       = '5,35 17-18 * 3-10 *';
const BEFORE_GAME_DAY_HOLIDAY = '5,35 13-16 * 3-10 0,6';
const AFTER_GAME_NIGHT        = '2,17,32,47 21-23 * 3-10 *';
const AFTER_GAME_DAY_HOLIDAY  = '2,17,32,47 16-18 * 3-10 0,6';
const AFTER_LEAVE_MOUND_STARTER_NIGHT       = '4-54/10 19-23 * 3-10 *';
const AFTER_LEAVE_MOUND_STARTER_DAY_HOLIDAY = '4-54/10 13-17 * 3-10 0,6';
const DURING_GAME_NIGHT       = '7-57/10 18-21 * 3-10 *';
const DURING_GAME_DAY_HOLIDAY = '7-57/10 13-17 * 3-10 0,6';
