...
import { findSavedTweeted, getIsTweet, tweetMulti, saveTweeted, SC_GFS } from '../tweet/tw_util';
    ...
    if (getIsTweet()) {
      ...
      if (! savedTweeted && isLeft) {
        ...
        console.log(format(
          ...
          dayArg, 'ALL', SC_GFS, savedTweeted ? 'done tweet' : !isLeft ? 'not left mound starter' : 'other'
        ));
      }
    } else {
