...
-- insert into _order_detail_diff (`oo_id`,`top_bottom`,`team`,`pitch_count`,`batting_order`,`pos`,`player`,`player_name`,`prv_pos`,`prv_player`,`prv_player_name`,`same`)
